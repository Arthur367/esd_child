...
const createReceipt = require('./functions.js')
...
app.post('/total_notworking', (req, res) => {
  ...
  url_Settings = axios.get(`${print_host}/Settings(com=,baud=,tcp=1,ip=${req.headers.printerip},port=${req.headers.printerport},password=${req.headers.senderid})`)
